...
//        tpane.setTranslateY(100);
    ...
    public Pane getAllProductsadmin(){
        TableView<Product> table1 = new TableView<>();
        ...
        ObservableList<Product> productData = Product.getAllProductsadmin();
table1.setPrefSize(100,100);
        ...
        tpane.setPrefSize(100, 100);
       //tpane.setTranslateY(10);
        return tpane;
    }
